...
question = "Are you sure to continue as " + spy.salutation + " " + spy.name + " (Y/N)? \n"
...
if existing.upper() == "Y":
   ...
   if len(spy.name)>0:
       ...
       if len(spy.salutation)>0:
           spy.name=spy.salutation + " " + spy.name
           print "Fabulous"+spy.name+".i'd like to know about more before we proceed"
           ...
           if spy.age<50 and spy.age>12:
              spy.rating=raw_input("Your spy_rating\n")
